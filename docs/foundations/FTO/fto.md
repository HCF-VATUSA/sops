...
!!! warning "For Simulation Use Only"
...
1. Training is scheduled through the "Scheddy" training application, available at [https://scheddy.vhcf.net/](https://scheddy.vhcf.net/). Booking a session serves as a reservation. The assigned trainer will notify the student whether the session is confirmed.
...
For additional information, refer to the [VATUSA General Training Policy](https://www.vatusa.net/info/policies).
...
![Common Equipment Suffix Codes](img/equipment-codes.png)

##### Weather

![METAR Deciphered](img/metar-decoded.png)
...
![Wake Turbulence Separation Minima](img/wake-turbulence-minima.png)
